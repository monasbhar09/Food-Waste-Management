 ...
 * @author Monas
 */
public class RestaurantFoodWasteLineChartJPanel extends javax.swing.JPanel {
    ...
    public RestaurantFoodWasteLineChartJPanel(JPanel userProcessContainer, RestaurantOrganization restaurantOrganization) {
        initComponents();
    ...
    private static JFreeChart createChart(DefaultCategoryDataset dataset) {
        JFreeChart chart = ChartFactory.createLineChart("Waste Vs Time", "Time", "Waste", dataset, PlotOrientation.VERTICAL, true, true, false);
    ...
    private DefaultCategoryDataset createDataset() {
        ...
        for (String date : listDistinct) {
            ...
            dataset.addValue(wasteFood, "waste", date);
        }
        return dataset;
    }
